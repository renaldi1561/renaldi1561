<?php 
require("../sistem/pbd_dasar/19753058_koneksi.php");
...
function read_data() {
	...
	<table border="1" cellpadding="2">
		<tr>
			<td colspan="5"><a href="19753058_curd_4.php?a=input">INPUT</a></td>
		</tr>
		<tr>
			<td>ID</td>
			<td>KODE</td>
		...
		<tr>
			...
			<td>
				<a href="19753058_curd_4.php?a=edit&id=<?php echo $row ['idprodi']; ?>">EDIT</a>
				<a href="19753058_curd_4.php?a=hapus&id=<?php echo $row ['idprodi']; ?>">HAPUS</a>
			</td>
		</tr>
		<?php } ?>
	</table>
...
function input_data(){
	...
	<form action="19753058_curd_4.php?a=input" method="post"> 
		...
		<br>
		<a href="19753058_curd_4.php?a=list">Batal</a>
	</form>
<?php } ?>
...
<h2>Edit Data Program Studi</h2>
	<form action="19753058_curd_4.php?a=list" method="post">
...
function update_prodi() {
	global $hub;
	global $_POST;
	$query = "update dt_prodi SET";
	$query .=" kdprodi='" .$_POST["kdprodi"]."', nmprodi= '".$_POST["nmprodi"]."', akreditasi='".$_POST["akreditasi"]."' WHERE idprodi = ".$_POST["idprodi"];
	$result = mysqli_query($hub,$query) or die(mysqli_error());
}
